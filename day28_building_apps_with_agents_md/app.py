...
st.set_page_config(
    page_title="Day 28: AI-Assisted Development",
...
st.write(
    "Learn how to use AGENTS.md to build Streamlit apps effortlessly with AI assistants like ChatGPT, Claude, or Cursor."
)
...
with st.sidebar:
    ...
    st.info(
        "AGENTS.md is like a README for AI—it contains all patterns, conventions, and instructions that help AI assistants build your apps correctly.",
        icon=":material/info:",
    )
...
tab1, tab2 = st.tabs(
    [
        ":material/flash_on: Mode 1: Quick Start",
        ":material/quiz: Mode 2: Guided Questions",
    ]
)
...
with tab2:
    ...
    st.write(
        "Not sure what you need? Let the AI guide you through questions, **one at a time**."
    )
        ...
        **3. AI builds complete app**
        ...
        with st.container(border=True):
            ...
            qa_chatbot = [
                ...
                (
                    ":material/smart_toy: AI",
                    ":material/check_circle: Building your chatbot app...",
                ),
            ]
        ...
        with st.container(border=True):
            ...
            qa_dashboard = [
                ...
                (
                    ":material/smart_toy: AI",
                    ":material/check_circle: Building your dashboard...",
                ),
            ]
            ...
            st.caption(
                ":material/lightbulb: Note: AI didn't ask about LLM because dashboards don't need them!"
            )
...
with col1:
    with st.expander(
        ":material/cable: Universal Connection (Works Everywhere)", expanded=True
    ):
        st.code(
            """@st.cache_resource
def get_session():
